...
### Модель даних DDF (Distributed Data Framework) 
...
- **Властивість** - надає додаткову інформацію про якесь діскретне поняття (наприклад, поняття **country** може мати додаткову інформацію типу **full_name**, **latitude**, **longitude**).

- **Домен сутностей** - дискретне поняття, у якому визначені усі можливі його значення (наприклад, для поняття **country** можливо визначити усі країни існуючі у світу). Усі властивості для домену сутностей також є визначеними.

**Сутність** - це одне значення у домену сутностей. 

Сутності також можуть входити до **множин сутностей**, які **завжди** належать деякому домену сутностей та не виходять за його межи. Наприклад, ми можемо визначити домен сутностей **country** як множину, яка належіть домену сутностей **geographic places**, який також містить множини сутностей **city**, **province**, **continent**. Належність до сутностей визначається властивістю **is--\[сутність]** із булевим типом.
...
DDF також має **типі концептів**. Сама модель має декілка існуючих типів даних:
